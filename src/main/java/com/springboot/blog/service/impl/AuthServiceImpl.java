...
import com.springboot.blog.util.ERole;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String register(RegisterDto registerDto) {
        ...
        if(userRepository.existsByUsername(registerDto.getUsername())){
            throw new BlogAPIException(HttpStatus.BAD_REQUEST,"Username is already exists in DB");
        }
        //check if email id is already exists in DB
        if(userRepository.existsByEmail(registerDto.getEmail())){
            throw new BlogAPIException(HttpStatus.BAD_REQUEST,"Email id is already exist in DB");
        }
        User user=new User();
